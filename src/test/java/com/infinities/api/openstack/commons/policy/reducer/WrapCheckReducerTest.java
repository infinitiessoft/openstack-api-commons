...
import com.infinities.api.openstack.commons.policy.reducer.WrapCheckReducer;

public class WrapCheckReducerTest {
	...
	private WrapCheckReducer reducer;
	...
	public void setUp() throws Exception {
		...
		reducer = new WrapCheckReducer(base);
	...
	public void testGetEntry() {
		...
		assertEquals(check2, ret.getValue());

		context.checking(new Expectations() {

			{

				oneOf(check2).check(target, creds, enforcer);
	...
	public void testReduce2() {
		final List<Entry<String, BaseCheck>> entrys = new ArrayList<Entry<String, BaseCheck>>();
		Entry<String, BaseCheck> entry1 = Maps.immutableEntry("(", check1);
		Entry<String, BaseCheck> entry2 = Maps.immutableEntry("check", check2);
		Entry<String, BaseCheck> entry3 = Maps.immutableEntry(")", check3);
		entrys.add(entry1);
		entrys.add(entry2);
		entrys.add(entry3);
		context.checking(new Expectations() {
	...
	public void testReduce4() {
		final List<Entry<String, BaseCheck>> entrys = new ArrayList<Entry<String, BaseCheck>>();
		Entry<String, BaseCheck> entry1 = Maps.immutableEntry("(", check1);
		Entry<String, BaseCheck> entry2 = Maps.immutableEntry("and_expr", check2);
		Entry<String, BaseCheck> entry3 = Maps.immutableEntry(")", check3);
		entrys.add(entry1);
		entrys.add(entry2);
		entrys.add(entry3);
	...
	public void testReduce5() {
		final List<Entry<String, BaseCheck>> entrys = new ArrayList<Entry<String, BaseCheck>>();
		Entry<String, BaseCheck> entry1 = Maps.immutableEntry("(", check1);
		Entry<String, BaseCheck> entry2 = Maps.immutableEntry("or_expr", check2);
		Entry<String, BaseCheck> entry3 = Maps.immutableEntry(")", check3);
		entrys.add(entry1);
		entrys.add(entry2);
		entrys.add(entry3);
